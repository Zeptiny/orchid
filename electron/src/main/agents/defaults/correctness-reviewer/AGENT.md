...
type: subagent
tier: crown
description: Reviews code for logic errors, edge cases, state management bugs, error propagation failures, and intent-vs-implementation mismatches. Use when reviewing code changes for behavioral correctness.
allowed_tools:
  - read
  - read_directory
  - glob
