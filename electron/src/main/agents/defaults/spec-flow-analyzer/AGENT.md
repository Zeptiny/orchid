...
1. Use the content-search tool (e.g., grep) to find code related to the feature area -- models, controllers, services, routes, existing tests
2. Use the file-search tool (e.g., glob) to find related features that may share patterns or integrate with this one
