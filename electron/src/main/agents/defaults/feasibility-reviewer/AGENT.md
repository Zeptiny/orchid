...
type: subagent
tier: bloom
description: Evaluates whether proposed technical approaches in planning documents will survive contact with reality -- architecture conflicts, dependency gaps, migration risks, and implementability.
allowed_tools:
  - read
  - read_directory
  - glob
