...
from orchid.agents.manager import SubagentManager, SubagentRecord
from orchid.config import get_config
from orchid.domain.chain import Chain
from orchid.domain.message import Message
from orchid.domain.todo import TodoStore, set_todo_store
...
class SessionManager:
    ...
    def save(self, session: Session) -> None:
        ...
        from orchid.storage import save_session
    ...
    def load(self, session_id: str) -> Session | None:
        ...
        from orchid.storage import load_session
