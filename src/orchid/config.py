...
HOME_CONFIG_DIR = Path.home() / ".orchid"
...
PROJECT_AGENTS_DIR = ".orchid/agents"
PROJECT_SKILLS_DIR = ".orchid/skills"
PROJECT_RAG_DIR = ".orchid/rag"
RAG_VECTORS_FILE = "vectors.npy"
RAG_INDEX_DB = "index.db"
PROJECT_AST_DIR = ".orchid/ast"
...
_ENV_MAP = {
    ...
    "ORCHID_IGNORED_DIRS": "ignored_dirs",
...
_RAG_ENV_MAP = {
    "ORCHID_RAG_EMBEDDING_MODEL": "embedding_model",
    "ORCHID_RAG_CHUNK_SIZE": "chunk_size",
    "ORCHID_RAG_CHUNK_OVERLAP": "chunk_overlap",
    "ORCHID_RAG_TOP_K": "top_k",
    "ORCHID_RAG_MAX_FILE_SIZE": "max_file_size",
}
...
_VALID_TIERS = frozenset({"seed", "sprout", "bloom", "crown"})
...
class ConfigManager:
    ...
    def ensure_home_config(cls) -> None:
        ...
        from orchid.agents import load_agents, seed_agents_dir

        seed_agents_dir(HOME_AGENTS_DIR)
        load_agents()
        from orchid.skills import load_skills, seed_skills_dir
...
def set_current_personality(name: str) -> None:
    from orchid.personality import get_personality_registry
