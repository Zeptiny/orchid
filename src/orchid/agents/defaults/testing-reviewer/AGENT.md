...
type: subagent
tier: bloom
description: Reviews code for test coverage gaps, weak assertions, brittle implementation-coupled tests, and missing edge case coverage. Use when evaluating whether tests actually prove the code works.
allowed_tools:
  - read
  - read_directory
  - glob
