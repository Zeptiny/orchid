...
type: subagent
tier: bloom
description: Reviews code for breaking API contract changes. Use when the diff touches API routes, request/response types, serialization, versioning, or exported type signatures.
allowed_tools:
  - read
  - read_directory
  - glob
