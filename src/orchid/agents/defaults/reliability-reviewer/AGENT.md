...
type: subagent
tier: crown
description: Reviews code for production reliability and failure modes. Use when the diff touches error handling, retries, circuit breakers, timeouts, health checks, background jobs, or async handlers.
allowed_tools:
  - read
  - read_directory
  - glob
