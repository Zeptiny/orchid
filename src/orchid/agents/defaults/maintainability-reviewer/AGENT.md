...
type: subagent
tier: bloom
description: Reviews code for structural quality, complexity reduction, coupling, naming, dead code, type-boundary leaks, and abstraction debt. Use when evaluating whether changes make the codebase harder to change, delete, or reason about.
allowed_tools:
  - read
  - read_directory
  - glob
