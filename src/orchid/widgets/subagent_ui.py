...
from orchid.agents.manager import TERMINAL, SubagentRecord, SubagentState
...
from orchid.widgets.sidebar import Sidebar
...
class SubagentUIManager:
    ...
    def _tab_label(record: SubagentRecord) -> str:
        from orchid.agents.manager import SUBAGENT_INDICATORS
